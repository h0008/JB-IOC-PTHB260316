...
public class AttendanceManagement {
    ...
    static class Student {
        ...
        public String toString() {
            return "ID : " + id + " , Student name: " + name;
        }
    }
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (choice) {
                case 1: // Add
                    String nameAdd = "";
                    while (nameAdd.trim().isEmpty()) {
                        System.out.print("Enter student name: ");
                        nameAdd = scanner.nextLine();
                        if (nameAdd.trim().isEmpty()) System.out.println("Please do not leave it blank!");
                    }
                ...
                case 2: // Edit
                    ...
                    if (idxEdit == -1) {
                        System.out.println("No student found with id = " + idEdit);
                        break;
                    }
                    String newName = "";
                    while (newName.trim().isEmpty()) {
                        ...
                        if (newName.trim().isEmpty()) System.out.println("Please do not leave it blank!");
                    }
